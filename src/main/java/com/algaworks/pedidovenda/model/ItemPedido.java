...
public class ItemPedido implements Serializable {
	...
	@Transient
	public boolean isEstoqueSuficiente() {// O estoque é sufuciente?
		return this.getPedido().isEmitido() // Se foi emitido OU se estoque for
											// maior que quantidade do item
	...
	public boolean isEstoqueInsuficiente() {
		return !this.isEstoqueSuficiente(); // Retorna o contrario do
											// isEstoqueSuficiente
											// Nego
	}
